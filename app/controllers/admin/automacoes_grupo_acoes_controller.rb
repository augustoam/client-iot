class Admin::AutomacoesGrupoAcoesController < ApplicationController
  ...
  private
    ...
    def automacao_grupo_acao_params
      params.require(:automacao_grupo_acao).permit(:run_automation, :turn_on_off_automation, :send_notification,
                                                   :delay, :delay_time, :run_automacao_id, :turn_on_off_automation_id,
                                                   :automacao_grupo_id, :componente_ambiente_id)
    end
end
